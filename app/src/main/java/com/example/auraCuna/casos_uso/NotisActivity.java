...
public class NotisActivity extends AppCompatActivity {
    ...
    private void listenToSensorData() {
        // Escuchar cambios en el documento "cuna1" dentro de la colección "Cunas"
        firestore.collection("Cunas").document("cuna1")
                .addSnapshotListener((documentSnapshot, e) -> {
                    ...
                    if (documentSnapshot != null && documentSnapshot.exists()) {
                        ...
                        // Verificar el estado de la cuna
                        if ("vacia".equalsIgnoreCase(enCuna)) {
                            // Si el estadoCuna es vacío o nulo, el bebé no está en la cuna
                        ...
                        } else if ("ocupada".equalsIgnoreCase(enCuna)) {
                            // Si el estadoCuna es "ocupada", el bebé está en la cuna
    ...
    private void addNotification(String title, String description, String time) {
        ...
        Log.d("NotisActivity", "Notificación agregada: " + title + " - " + description);
